...
const contractABI = require("../artifacts/contracts/Digitalwane.sol/Digitalwane.json").abi;

program
    .name("digitalwane-cli")
    .description("CLI tool for Digitalwane smart contract")
    .version("1.0.0");
