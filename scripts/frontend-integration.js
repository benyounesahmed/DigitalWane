 ...
 * This file demonstrates how to integrate Digitalwane with a web frontend
 */

// For React/Vue/Angular applications
export class DigitalwaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DigitalwaneClient(provider, contractAddress);
